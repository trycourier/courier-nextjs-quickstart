 ...
 *
 * "use client" is required: the component uses hooks, and the inbox renders as
 * a custom element that only exists in the browser. You do NOT need
 * next/dynamic with `ssr: false` — the SDK is server-safe on import, so Next
 * can render this component's shell on the server and hydrate it here.
 */
